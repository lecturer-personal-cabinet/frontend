        ...
        return (
            ...
            >
                <Switch>
                    ...
                    <Route path='/s/portfolio/:cardId/display' component={PortfolioBuilder} />
                    <Route path='/s/portfolio/:userId' component={(props: any) => <PortfolioContainer {...props} isPublic={true} />}/>
